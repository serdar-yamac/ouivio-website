-- Provider-neutral registry for the autonomous sync worker. New providers
-- (Google, Microsoft) are added here only after their OAuth adapters exist.
...
as $$
  ...
  where connection.provider in ('apple')
