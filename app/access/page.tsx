...
export default function AccessPage() {
  return <main className={styles.shell}>
    ...
    <section className={styles.choices} aria-label="Kontoart auswählen">
      ...
      <Link className={`${styles.choice} ${styles.partner}`} href="/login?intent=partner"><span className={styles.icon}>✦</span><small>Für Unternehmen</small><h2>Leistungen anbieten</h2><p>Profil, Pakete und Verfügbarkeit anlegen – und später direkt buchbar werden.</p><b>Partnerkonto starten <i>→</i></b></Link>
    </section>
