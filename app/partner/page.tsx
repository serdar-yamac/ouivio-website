...
function CalendarConnections({ onSynced }: { onSynced: () => Promise<void> }) {
  ...
  const providers = [
    { provider: "google" as const, name: "Google Calendar", mark: "G", detail: "Google OAuth · nur belegte Zeiten", connected: googleConnected, helpTitle: "Google Calendar vorbereiten", helpText: "Google fragt Partnerinnen und Partner direkt nach ihrer sicheren Freigabe. Ihr gebt deshalb niemals ein Google-Passwort in Ouivio ein.", helpLink: "https://console.cloud.google.com/apis/credentials", helpLinkLabel: "Google Cloud Console öffnen", steps: ["Meldet euch mit dem Google-Konto an, das die Ouivio-Anwendung verwaltet.", "Aktiviert die Google Calendar API und erstellt einen OAuth-Client vom Typ „Webanwendung“.", "Hinterlegt die angezeigte Weiterleitungsadresse genau so in der Google-Cloud-Konsole."], setupHint: "Danach hinterlegt ihr Client-ID und Secret einmalig geschützt in den Ouivio-Projekteinstellungen. Das richten wir gemeinsam ein – diese Werte gehören nie in ein Partnerformular." },
    { provider: "microsoft" as const, name: "Outlook / Microsoft 365", mark: "M", detail: "Microsoft OAuth · nur belegte Zeiten", connected: microsoftConnected, helpTitle: "Outlook / Microsoft 365 vorbereiten", helpText: "Microsoft führt Partnerinnen und Partner zur sicheren Freigabe. Auch hier werden keine Microsoft-Passwörter in Ouivio gespeichert oder abgefragt.", helpLink: "https://entra.microsoft.com/#view/Microsoft_AAD_RegisteredApps/ApplicationsListBlade", helpLinkLabel: "Microsoft Entra öffnen", steps: ["Öffnet im Microsoft Entra Admin Center „App registrations“ und erstellt eine neue Registrierung.", "Wählt „Web“ als Plattform und erlaubt bei Bedarf auch persönliche Microsoft-Konten.", "Hinterlegt die angezeigte Weiterleitungsadresse genau so in der App-Registrierung."], setupHint: "Danach hinterlegt ihr Application (client) ID und Client Secret einmalig geschützt in den Ouivio-Projekteinstellungen. Diese Werte werden niemals in einem Partnerkonto eingegeben." },
  ];
