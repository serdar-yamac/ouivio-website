...
function CalendarConnections() {
  ...
  const testAppleConnection = async (event: React.FormEvent) => {
    ...
    try {
      ...
      setNotice("Apple Calendar ist verbunden. Das App-Passwort wurde verschlüsselt gespeichert; Ouivio liest künftig nur belegte Zeiten und schreibt nichts in euren Apple-Kalender.");
