...
import { calendarEncryptionKey, encryptCalendarCredentials } from "@/lib/calendar-credentials";
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const encryptedCredentials = encryptCalendarCredentials({ appleId, appPassword }, encryptionKey);
