...
- Apple-Calendar-Test korrigiert: Die serverseitige Partnerprüfung übernimmt nun die bestätigte Supabase-Sitzung auch für die anschließende, RLS-geschützte Profilsuche. Zuvor lief diese einzelne Datenbankabfrage anonym und brach deshalb vor dem Apple-Test mit HTTP 403 ab – unabhängig davon, ob Apple-ID und App-Passwort korrekt waren. Das App-Passwort wird weiterhin ausschließlich für den einmaligen Apple-Test verwendet und nicht gespeichert.
