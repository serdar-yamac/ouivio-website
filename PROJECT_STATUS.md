...
- Partner-Testzugang mit bestehender Kundensitzung abgesichert: Ruft ein angemeldetes Kundenkonto die Partnerregistrierung auf, wird es nicht mehr still in sein Kunden-Dashboard weitergeleitet. Stattdessen erklärt eine klare Zwischenansicht, dass ein separates Partnerkonto erforderlich ist, und bietet eine lokale Abmeldung dieses Browsers an. Danach bleibt das Partnerformular geöffnet. Die Abmeldung nutzt bewusst Supabases lokalen Scope und beendet keine Sitzungen auf anderen Geräten.
